...
export default function CurrencyConfigUI() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-1 pt-4 pb-3 bg-gray-50">
      {/* Buttons Row */}
      <div className="flex flex-wrap gap-3">
        <button
          onClick={() => setIsGSTModalOpen(true)}
          className="flex items-center gap-2 px-5 py-3 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors shadow-sm"
        >
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center justify-between gap-3 px-5 py-3 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors shadow-sm min-w-[320px]"
          >
        ...
        <button className="flex items-center gap-2 px-5 py-3 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
          <svg className="w-5 h-5 text-purple-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between px-8 py-6 border-b border-gray-200">
              <h2 className="text-2xl font-semibold text-gray-900">Configure Tax</h2>
            ...
            <div className="flex items-center justify-between px-8 py-6 border-t border-gray-200">
              <button onClick={() => setIsGSTModalOpen(false)} className="text-gray-700 font-medium hover:text-gray-900">Cancel</button>
              <button onClick={saveGSTConfiguration} className="px-8 py-3 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 shadow-sm">Save Changes</button>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto px-8 py-6">
              <div className="bg-purple-50 rounded-lg p-6 mb-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Need Advanced Formulas?</h3>
                <p className="text-gray-700 mb-4">Add custom calculations, formulae and custom fields in your columns.</p>
                <button className="px-6 py-2 bg-pink-600 text-white font-medium rounded-lg hover:bg-pink-700">
              ...
              <div className="flex justify-between items-center mb-6">
                <div className="grid grid-cols-2 gap-4 flex-1">
                  <div>
                    <label className="block text-gray-700 font-bold mb-2 px-12">Column Name</label>
                  </div>
                  <div>
                    <label className="block text-gray-700 font-bold  px-20 mb-2">Column Type</label>
                  </div>
                </div>
                <button
                  onClick={addNewColumn}
                  className="ml-4 flex items-center gap-2 px-4 py-2 text-purple-600 border-2 border-purple-600 rounded-lg hover:bg-purple-50 font-medium"
                >
                  <Plus className="w-5 h-5" />
                  Add New Column
                </button>
            ...
            <div className="flex items-center justify-between px-8 py-6 border-t border-gray-200 bg-white">
              <button onClick={() => setIsColumnsModalOpen(false)} className="text-gray-700 font-medium hover:text-gray-900">
                Cancel
              </button>
              <div className="flex gap-3">
                <button className="px-6 py-3 text-gray-700 border border-gray-300 rounded-lg font-medium hover:bg-gray-50">
                  Reset to Default
                </button>
                <button onClick={saveColumnConfiguration} className="px-8 py-3 bg-pink-600 text-white font-medium rounded-lg hover:bg-pink-700">
                  Save
                </button>
              </div>
            </div>
