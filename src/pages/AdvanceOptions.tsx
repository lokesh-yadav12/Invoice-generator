...
export default function AdvancedOptionsUI() {
  ...
  return (
    <div className="p-8">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-2xl font-semibold text-gray-900 mb-8">Advanced Options</h2>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <button
                ...
                className="w-96 px-4 py-1 border-2 text-sm border-black/10 rounded-lg bg-white text-left flex items-center justify-between hover:border-purple-400 transition-all focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200"
              >
              ...
              {showHsnDropdown && (
                <div className="absolute z-10 w-96 mt-2 bg-white border-2 border-black/10 rounded-lg shadow-lg overflow-hidden">
          ...
          <div>
            ...
            <div className="relative">
              ...
              {showTaxDropdown && (
                <div className="absolute z-10 w-96 mt-2 bg-white border-2 border-purple-200 rounded-lg shadow-lg overflow-hidden">
