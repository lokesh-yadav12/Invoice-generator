...
export default function DocumentActionsUI() {
	...
	return (
		<div className=" bg-gray-50 p-2">
			<div className="max-w-6xl mx-auto">
				...
				{savedSignature && (
					<div className="mb-4 bg-white rounded-lg border-2 border-purple-200 py-12">
				...
				<div className="mb-6">
					<button
						...
						className="w-full border-2 border-dashed text-sm border-gray-300 rounded-lg px-6 py-2 bg-white hover:border-purple-400 hover:bg-purple-50 transition-all duration-200 flex items-center justify-center gap-3 text-gray-700 font-medium"
					>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
					<button
						...
						className="border-2 border-dashed text-sm border-gray-300 rounded-lg px-6 py-2 bg-white hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-3 text-gray-700 font-medium"
					>
					...
					<button
						...
						className="border-2 border-dashed text-sm border-gray-300 rounded-lg px-6 py-2 bg-white hover:border-purple-400 hover:bg-purple-50 transition-all duration-200 flex items-center justify-center gap-3 text-gray-700 font-medium"
					>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<button
						...
						className="border-2 border-dashed border-gray-300 text-sm rounded-lg px-6 py-2 bg-white hover:border-purple-400 hover:bg-purple-50 transition-all duration-200 flex items-center justify-center gap-3 text-gray-700 font-medium"
					>
						<FileText className="w-5 h-5 text-purple-600" />
				...
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
					<div className="bg-white rounded-lg shadow-xl w-full max-w-3xl">
						...
						<div className="flex items-center justify-between p-6 border-b">
							<h2 className="text-2xl font-semibold text-gray-900">Your Contact Details</h2>
							<button
								...
								<div className="flex items-center gap-2">
									...
									<div className="flex items-center gap-2 px-3 py-2 border border-gray-300 rounded-lg bg-gray-50">
										...
										<input
											...
											className="bg-transparent border-none outline-none text-gray-700 placeholder-gray-400 min-w-[300px]"
										/>
									</div>
								</div>
                        ...
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
										...
										<input
											...
											className="px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 outline-none focus:ring-2 focus:ring-purple-500 min-w-[150px]"
										/>
									</div>
								</div>
							</div>
							...
							{/* Save Button */}
							<div className="mt-6 flex justify-start px-24 gap-3">
								<button
									onClick={() => setShowContactModal(false)}
									className="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors"
								>
