...
const HorizontalScrollWorkflow = () => {
	...
	return (
		<div ref={sectionRef} className="min-h-[300vh] sm:min-h-[400vh] md:min-h-[500vh] lg:min-h-[600vh] relative">
			{/* Animated Background */}
				...
				<div className="w-full px-4 sm:px-6 md:px-8 lg:px-16">
					...
					>
						{tools.map((tool, index) => (
							...
							>
								<div
									className={`relative h-[380px] sm:h-[400px] md:h-[440px] lg:h-[460px] rounded-xl md:rounded-2xl overflow-hidden border border-gray-200 hover:border-gray-300 transition-all duration-500 group-hover:scale-105 group-hover:shadow-2xl ${
								...
								>
									...
									{/* Content */}
									<div className="relative h-full p-10 sm:p-6 md:p-7 lg:p-8 flex flex-col items-center text-center z-10">
